...
/**
 * Delete listening history for a user
 *
 * userId Integer 
 * no response value expected for this operation
 **/
exports.usersUserIdHistoryDELETE = function(userId) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
 ...
 * returns List
 **/
exports.usersUserIdHistoryGET = function(userId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "duration" : "duration",
 ...
 * returns List
 **/
exports.usersUserIdRecommended_songsGET = function(userId) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
  "duration" : "duration",
